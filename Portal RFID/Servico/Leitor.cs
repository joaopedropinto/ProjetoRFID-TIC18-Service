...
namespace PortalRFID
{
    ...
    public class Leitor : ILeitor
    {
        ...
        public bool IsReaderOk(string ipPorta)
        {
            ...
            // Daniel Tomy solicitou que esta função sempre retornasse "true", pois assim ele sabe se o serviço está OK ou não.
#if (true) 
            try
            {
        ...
        public List<TagRfidType> GetTagsRfid(int antNum, string ipPorta, string filtro, int tempoLeitura, bool readUser, int potenciaPadrao, int potenciaAntena1 = 0, int potenciaAntena2 = 0, int potenciaAntena3 = 0, int potenciaAntena4 = 0)
        {
            int[][] antenas = null;
        ...
        private List<TagRfidType> GetTagRfidFlex(int[][] antenas, string ipPorta, string filtro, int tempoLeitura, bool lerMemoriaUsuario, int potenciaPadrao)
        {
            List<TagRfidType> tags = new List<TagRfidType>(); // Instancia a lista de tags.
            ...
            try
            {
                ...
                using (Reader r = Reader.Create("tcp://" + ipPorta)) //usar URI “IP do leitor:Porta 8081”
                {
                    ...
                    {
                        TagRfidType tag = new TagRfidType();
